...
find_dependency_with_major_and_minor(Qt5Core 5 15)
find_dependency_with_major_and_minor(Qt5Gui 5 15)
find_dependency_with_major_and_minor(Qt5Network 5 15)
...
get_target_property(_configurations Qt5::WebKit IMPORTED_CONFIGURATIONS)
list(FIND _configurations RELEASE _index)
if (${_index} GREATER -1)
    list(REMOVE_AT _configurations ${_index})
    list(INSERT _configurations 0 RELEASE)
    set_property(TARGET Qt5::WebKit PROPERTY IMPORTED_CONFIGURATIONS "${_configurations}")
endif ()
