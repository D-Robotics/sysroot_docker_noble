 ...
 * @tm_tag_local_var_t:  Local variable (inside function)
 * @tm_tag_other_t:  Other (non C/C++/Java tag)
 * @tm_tag_include_t:  C/C++ included header file name.
...
typedef enum {
	...
	tm_tag_local_var_t = 262144,
	tm_tag_other_t = 524288,
	tm_tag_include_t = 1048576,
	tm_tag_max_t = 2097151,
} TMTagType;
 ...
 * @tm_tag_attr_flags_t:  Additional flags.
 ...
 * @use_native_windows_dialogs:  whether to use native Windows' dialogs - ignored and not used anymore
 ...
 * @warn_on_project_close:  whether to show a warning when closing a project to open a new one
 * @openfiles_path_mode:  
 * @tab_label_len:  number of characters of a filename to be visible on the tab label
 *
 * 
 ...
 *
 * 
 * Deprecated: sci_get_selected_text_length is deprecated and should not be used in newly-written code. Use sci_get_selected_text_length2() instead. 
 * 
 * 
 * 
 * 
