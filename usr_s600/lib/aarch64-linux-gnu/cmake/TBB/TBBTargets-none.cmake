...
set_target_properties(TBB::tbb PROPERTIES
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libtbb.so.12.11"
  IMPORTED_SONAME_NONE "libtbb.so.12"
  )

list(APPEND _cmake_import_check_targets TBB::tbb )
list(APPEND _cmake_import_check_files_for_TBB::tbb "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libtbb.so.12.11" )
...
set_target_properties(TBB::tbbmalloc PROPERTIES
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libtbbmalloc.so.2.11"
  IMPORTED_SONAME_NONE "libtbbmalloc.so.2"
  )

list(APPEND _cmake_import_check_targets TBB::tbbmalloc )
list(APPEND _cmake_import_check_files_for_TBB::tbbmalloc "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libtbbmalloc.so.2.11" )
...
set_target_properties(TBB::tbbmalloc_proxy PROPERTIES
  ...
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libtbbmalloc_proxy.so.2.11"
  IMPORTED_SONAME_NONE "libtbbmalloc_proxy.so.2"
  )

list(APPEND _cmake_import_check_targets TBB::tbbmalloc_proxy )
list(APPEND _cmake_import_check_files_for_TBB::tbbmalloc_proxy "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libtbbmalloc_proxy.so.2.11" )
...
set_target_properties(TBB::tbbbind_2_5 PROPERTIES
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libtbbbind_2_5.so.3.11"
  IMPORTED_SONAME_NONE "libtbbbind_2_5.so.3"
  )

list(APPEND _cmake_import_check_targets TBB::tbbbind_2_5 )
list(APPEND _cmake_import_check_files_for_TBB::tbbbind_2_5 "${_IMPORT_PREFIX}/lib/aarch64-linux-gnu/libtbbbind_2_5.so.3.11" )
