...
typedef enum {
	TASK_L_RETRY = 0x10000, /**< Retry task process in lower layer */
	TASK_USER_DEFINE, /**< User defined status */
}hb_task_dbg_status_t;
...
typedef void (*task_debug_t)(hb_bpu_task_t task, hb_task_dbg_status_t st, uint64_t dbg_value, void *data);
hb_bpu_err_t hb_bpu_task_debug_register(hb_bpu_task_t task, task_debug_t cb, void *data);
hb_bpu_err_t hb_bpu_task_debug_unregister(hb_bpu_task_t task);
hb_bpu_err_t hb_bpu_task_debug_trigger(hb_bpu_task_t task, uint64_t dbg_value);
