...
typedef enum hb_vnode_type_e {
	...
	HB_IPU_V0, // XJ3
	HB_PYM_V0, // XJ3
	HB_GDC, // XJ3/Ultra/Super SoC
	HB_VIN_V1, // Ultra
	HB_ISP_V1, // Ultra
	HB_PYM_V1, // Ultra
	HB_STITCH, // Ultra/Super SoC
	HB_LKOF, // Ultra
	HB_VIN, // Super SoC
	HB_ISP, // Super SoC
	HB_YNR, // Super SoC
	HB_PYM, // Super SoC
	HB_IDU, // XJ3/Ultra/Super SoC
	HB_VPU, // XJ3/Ultra/Super SoC
	HB_JPU, // XJ3/Ultra/Super SoC
	HB_CODEC, // XJ3/Ultra/Super SoC
	HB_VIN_RB, // X5
	HB_ISP_RB, // X5
	HB_VSE, // X5
	HB_N2D, // X5
