...
enum : int {
    ...
    SBK_QTDATAVISUALIZATION_QLIST_QOBJECTPTR_IDX             = 2, // const QList<QObject* > &
    SBK_QTDATAVISUALIZATION_QLIST_QBYTEARRAY_IDX             = 3, // QList<QByteArray >
    SBK_QTDATAVISUALIZATION_QVECTOR_UCHAR_IDX                = 4, // QVector<uchar > *
    SBK_QTDATAVISUALIZATION_QVECTOR_UNSIGNEDINT_IDX          = 5, // const QVector<unsigned int > &
    SBK_QTDATAVISUALIZATION_QVECTOR_QIMAGEPTR_IDX            = 6, // const QVector<QImage* > &
    SBK_QTDATAVISUALIZATION_QVECTOR_QTDATAVISUALIZATION_QBARDATAITEM_IDX = 7, // QVector<QtDataVisualization::QBarDataItem > *
    SBK_QTDATAVISUALIZATION_QVECTOR_QTDATAVISUALIZATION_QSURFACEDATAITEM_IDX = 8, // QVector<QtDataVisualization::QSurfaceDataItem > *
    SBK_QTDATAVISUALIZATION_QVECTOR_QTDATAVISUALIZATION_QSCATTERDATAITEM_IDX = 9, // const QVector<QtDataVisualization::QScatterDataItem > &
    SBK_QTDATAVISUALIZATION_QVECTOR_FLOAT_IDX                = 10, // QVector<float > &
    SBK_QTDATAVISUALIZATION_QLIST_QTDATAVISUALIZATION_QCUSTOM3DITEMPTR_IDX = 11, // QList<QtDataVisualization::QCustom3DItem* >
    SBK_QTDATAVISUALIZATION_QLIST_QTDATAVISUALIZATION_QABSTRACT3DINPUTHANDLERPTR_IDX = 12, // QList<QtDataVisualization::QAbstract3DInputHandler* >
    SBK_QTDATAVISUALIZATION_QLIST_QTDATAVISUALIZATION_Q3DTHEMEPTR_IDX = 13, // QList<QtDataVisualization::Q3DTheme* >
    SBK_QTDATAVISUALIZATION_QLIST_QTDATAVISUALIZATION_QABSTRACT3DAXISPTR_IDX = 14, // QList<QtDataVisualization::QAbstract3DAxis* >
    SBK_QTDATAVISUALIZATION_QLIST_QTDATAVISUALIZATION_QBAR3DSERIESPTR_IDX = 15, // QList<QtDataVisualization::QBar3DSeries* >
    SBK_QTDATAVISUALIZATION_QLIST_QTDATAVISUALIZATION_QVALUE3DAXISPTR_IDX = 16, // QList<QtDataVisualization::QValue3DAxis* >
    SBK_QTDATAVISUALIZATION_QLIST_QTDATAVISUALIZATION_QSURFACE3DSERIESPTR_IDX = 17, // QList<QtDataVisualization::QSurface3DSeries* >
    SBK_QTDATAVISUALIZATION_QLIST_QTDATAVISUALIZATION_QSCATTER3DSERIESPTR_IDX = 18, // QList<QtDataVisualization::QScatter3DSeries* >
