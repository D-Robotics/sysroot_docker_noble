...
class Ui_SettingsDialog_base(object):
    def setupUi(self, SettingsDialog_base):
        ...
        self.AutoRefreshCheckBox.toggled['bool'].connect(self.AutoRefreshRateSpinBox.setEnabled) # type: ignore
        self.AutoRefreshCheckBox.toggled['bool'].connect(self.RefreshAllRadioButton.setEnabled) # type: ignore
        self.AutoRefreshCheckBox.toggled['bool'].connect(self.RefreshCurrentRadioButton.setEnabled) # type: ignore
        self.StdButtons.accepted.connect(SettingsDialog_base.accept) # type: ignore
        self.StdButtons.rejected.connect(SettingsDialog_base.reject) # type: ignore
