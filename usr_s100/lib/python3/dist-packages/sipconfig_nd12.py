...
_pkg_config = {
    ...
    'deployment_target':  '',
    'platform':           'linux-g++',
    'py_conf_inc_dir':    '/usr/include/python3.12',
    'py_inc_dir':         '/usr/include/python3.12',
    'py_lib_dir':         '/usr/lib/python3.12/config',
    'py_version':         0x030c02,
    'qt_framework':       0,
    'sip_bin':            '/usr/bin/sip',
    'sip_config_args':    '--destdir /usr/lib/python3/dist-packages --debug --no-dist-info CFLAGS=-g -O2 -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer -ffile-prefix-map=/build/sip4-fKXs9u/sip4-4.19.25+dfsg=. -flto=auto -ffat-lto-objects -fstack-protector-strong -fstack-clash-protection -Wformat -Werror=format-security -mbranch-protection=standard -fdebug-prefix-map=/build/sip4-fKXs9u/sip4-4.19.25+dfsg=/usr/src/sip4-4.19.25+dfsg-5build3 -Wdate-time -D_FORTIFY_SOURCE=3 CXXFLAGS=-g -O2 -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer -ffile-prefix-map=/build/sip4-fKXs9u/sip4-4.19.25+dfsg=. -flto=auto -ffat-lto-objects -fstack-protector-strong -fstack-clash-protection -Wformat -Werror=format-security -mbranch-protection=standard -fdebug-prefix-map=/build/sip4-fKXs9u/sip4-4.19.25+dfsg=/usr/src/sip4-4.19.25+dfsg-5build3 -Wdate-time -D_FORTIFY_SOURCE=3 LFLAGS=-Wl,-Bsymbolic-functions -flto=auto -ffat-lto-objects -Wl,-z,relro',
    'sip_inc_dir':        '/usr/include/python3.12',
...
_default_macros = {
    ...
    'AR':                       'ar cqs',
    'CC':                       'gcc',
    'CFLAGS':                   '-g -O2 -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer -ffile-prefix-map=/build/sip4-fKXs9u/sip4-4.19.25+dfsg=. -flto=auto -ffat-lto-objects -fstack-protector-strong -fstack-clash-protection -Wformat -Werror=format-security -mbranch-protection=standard -fdebug-prefix-map=/build/sip4-fKXs9u/sip4-4.19.25+dfsg=/usr/src/sip4-4.19.25+dfsg-5build3 -Wdate-time -D_FORTIFY_SOURCE=3',
    'CFLAGS_APP':               '',
    'CFLAGS_CONSOLE':           '',
    'CFLAGS_DEBUG':             '-g',
    ...
    'COPY':                     'cp -f',
    'CXX':                      'g++',
    'CXXFLAGS':                 '-g -O2 -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer -ffile-prefix-map=/build/sip4-fKXs9u/sip4-4.19.25+dfsg=. -flto=auto -ffat-lto-objects -fstack-protector-strong -fstack-clash-protection -Wformat -Werror=format-security -mbranch-protection=standard -fdebug-prefix-map=/build/sip4-fKXs9u/sip4-4.19.25+dfsg=/usr/src/sip4-4.19.25+dfsg-5build3 -Wdate-time -D_FORTIFY_SOURCE=3',
    'CXXFLAGS_APP':             '',
    'CXXFLAGS_CONSOLE':         '',
    'CXXFLAGS_DEBUG':           '-g',
    ...
    'LFLAGS':                   '-Wl,-Bsymbolic-functions -flto=auto -ffat-lto-objects -Wl,-z,relro',
    'LFLAGS_CONSOLE':           '',
    'LFLAGS_CONSOLE_DLL':       '',
    'LFLAGS_DEBUG':             '',
    'LFLAGS_DLL':               '',
