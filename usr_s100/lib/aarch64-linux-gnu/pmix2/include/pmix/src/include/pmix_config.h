...
#define PACKAGE_STRING "pmix 5.0.1a1"
...
#define PACKAGE_VERSION "5.0.1a1"
...
#define PMIX_CONFIGURE_CLI " \'--build=aarch64-linux-gnu\' \'--prefix=/usr\' '--includedir=${prefix}/include' '--mandir=${prefix}/share/man' '--infodir=${prefix}/share/info' \'--sysconfdir=/etc\' \'--localstatedir=/var\' \'--disable-option-checking\' \'--disable-silent-rules\' '--libdir=${prefix}/lib/aarch64-linux-gnu' \'--runstatedir=/run\' \'--disable-maintainer-mode\' \'--disable-dependency-tracking\' \'--with-ucx=/usr\' \'--prefix=/usr/lib/aarch64-linux-gnu/pmix2\' \'--libdir=/usr/lib/aarch64-linux-gnu/pmix2/lib\' \'--includedir=/usr/lib/aarch64-linux-gnu/pmix2/include\' \'--sysconfdir=/usr/lib/aarch64-linux-gnu/pmix2/share\' \'--datarootdir=/usr/lib/aarch64-linux-gnu/pmix2/share\' \'--with-curl\' \'--with-zlib=/usr\' \'--with-zlib-libdir=/usr/lib/aarch64-linux-gnu\' \'--with-jansson-libdir=/usr/lib/aarch64-linux-gnu\' \'--with-hwloc=/usr\' \'--with-hwloc-libdir=/usr/lib/aarch64-linux-gnu\' \'--enable-python-bindings\' \'--enable-shared\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "Mon Apr  1 04:38:57 UTC 2024"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "hostname"

/* User who built PMIx */
#define PMIX_CONFIGURE_USER "username"
...
#define PMIX_PACKAGE_STRING "PMIx username@hostname Distribution"
...
#define PMIX_REPO_REV "2024-04-01"
